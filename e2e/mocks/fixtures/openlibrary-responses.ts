 ...
 */
export const OPENLIBRARY_FIXTURES: Record<string, OpenLibrarySearchResponse> = {
 ...
 */
export function getOpenLibraryResponse(
  title: string,
  author: string
 ...
 */
export const EMPTY_RESPONSE: OpenLibrarySearchResponse = {
  numFound: 0,
  start: 0,
  numFoundExact: true,
  docs: []
