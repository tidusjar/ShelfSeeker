...
export class MockIrcServer {
     ...
     */
    handleCommand(socket, line, currentNick, setNick) {
     ...
     */
    async handleSearch(socket, query) {
     ...
     */
    async handleBookDownload(socket, botName, filename) {
     ...
     */
    async sendDccFile(clientSocket, filepath, filename, filesize, fromBot = 'search') {
        return new Promise((resolve) => {
            ...
            dccServer.listen(0, '127.0.0.1', () => {
                const address = dccServer.address();
